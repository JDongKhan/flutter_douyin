...
CodeInputBuilder pinRectangle(BuildContext context,
  ...
  if (edgeInsets?.horizontal != null) {
    padding = (edgeInsets?.horizontal ?? 0) / 2;
  }
...
CodeInputBuilder _pinContainerized(
  ...
  const Radius borderRadiusSize = Radius.circular(4);

  const Color borderColor = Color.fromARGB(255, 151, 151, 151);
  ...
  final BoxDecoration decorationSecond = BoxDecoration(
    border: const Border(
      top: BorderSide(width: width, color: borderColor),
  ...
  ///开始带弧度的 border
  final BoxDecoration decorationStart = BoxDecoration(
    border: const Border(
      top: BorderSide(width: width, color: borderColor),
      left: BorderSide(width: width, color: borderColor),
  ...
  ///结束带弧度的 border
  final BoxDecoration decorationEnd = BoxDecoration(
    border: const Border(
      top: BorderSide(width: width, color: borderColor),
      left: BorderSide(width: width, color: borderColor),
      right: BorderSide(width: width, color: borderColor),
...
CodeInputBuilder pinLine(BuildContext context) {
  const double codeSize = 4;
  final double width = MediaQuery.of(context).size.width / 2;
  final double codeFullSize = width / codeSize;
  final double codeNormalSize = codeFullSize - 10;
